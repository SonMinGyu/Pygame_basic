...
enemy = pygame.image.load(
    "C:\\Users\\littl\\OneDrive\\바탕 화면\\python\\pygame_basic\\enemy.png")
enemy_size = enemy.get_rect().size  # 캐릭터 사이즈 가져오기
enemy_width = enemy_size[0]  # 캐릭터 가로크기
enemy_height = enemy_size[1]  # 캐릭터 세로크기
enemy_x_pos = (screen_width / 2) - (enemy_width / 2)  # 화면 가로의 가운데
enemy_y_pos = (screen_height / 2) - (enemy_height / 2)  # 화면 세로의 바닥
